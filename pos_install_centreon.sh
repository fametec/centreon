...
#curl -d address='localhost' -d port='3306' -d root_password='' -d db_configuration='centreon' -d db_storage='centreon_storage' -d db_user='centreon' -d db_password='q1w2Q!W@' -d db_passwordd
_confirm='q1w2Q!W@' http://localhost/centreon/install/steps/process/process_step6.php
