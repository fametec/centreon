...
# Upgrading Centreon
DI=`ssh root@IP_New_Centreon -c "ls -1 /usr/share/centreon/installDir"`
ssh root@$IP_New_Centreon "mv /usr/share/centreon/installDir/$(DI) /usr/share/centreon/www/install"
